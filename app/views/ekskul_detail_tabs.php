    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-end">
                <a href="index.php?mod=ekskul" class="btn btn-secondary btn-sm float-right"><i class="fas fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="card card-primary card-outline card-tabs">
            <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link <?= $tab == 'program' ? 'active' : '' ?>" href="index.php?mod=ekskul&id=<?= $ekskul['id_ekskul'] ?>&tab=program">Program Kerja</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $tab == 'anggota' || $tab == 'kegiatan' ? 'active' : '' ?>" href="index.php?mod=ekskul&id=<?= $ekskul['id_ekskul'] ?>&tab=anggota">Anggota</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $tab == 'jurnal' ? 'active' : '' ?>" href="index.php?mod=ekskul&id=<?= $ekskul['id_ekskul'] ?>&tab=jurnal">Jurnal & Absensi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $tab == 'galeri' ? 'active' : '' ?>" href="index.php?mod=ekskul&id=<?= $ekskul['id_ekskul'] ?>&tab=galeri">Galeri</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $tab == 'nilai' ? 'active' : '' ?>" href="index.php?mod=ekskul&id=<?= $ekskul['id_ekskul'] ?>&tab=nilai">Penilaian</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active">
                        <div class="mb-3">
                            <a href="index.php?mod=ekskul&act=jurnal_form&id_ekskul=<?= $ekskul['id_ekskul'] ?>" class="btn btn-primary">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?mod=ekskul&act=jurnal_form&id_ekskul=<?= $ekskul['id_ekskul'] ?>&id_jurnal=<?= $j['id_jurnal'] ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                        <a href="index.php?mod=ekskul&act=jurnal_delete&id_ekskul=<?= $ekskul['id_ekskul'] ?>&id_jurnal=<?= $j['id_jurnal'] ?>" class="btn btn-sm btn-danger btn-delete-confirm"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="d-flex justify-content-center align-items-center" style="gap: 5px;">
                                                                ...
                                                                <?php endif; ?>
                                                                <a href="index.php?mod=ekskul&act=program_delete&id_ekskul=<?= $ekskul['id_ekskul'] ?>&id_program=<?= $p['id_program'] ?>" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="d-flex justify-content-center align-items-center" style="gap: 5px;">
                                                                ...
                                                                <a href="index.php?mod=ekskul&act=program_delete_file&id_ekskul=<?= $ekskul['id_ekskul'] ?>&id_program=<?= $p['id_program'] ?>" 
                                        ...
                                        <div class="card-body p-2 d-flex flex-column justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-2">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <a href="index.php?mod=ekskul&act=galeri_delete&id_ekskul=<?= $ekskul['id_ekskul'] ?>&id_galeri=<?= $g['id_galeri'] ?>" 
                    ...
                    <?php if ($tab == 'nilai'): ?>
                    <div class="tab-pane fade show active">
                        <form action="index.php?mod=ekskul&act=nilai_save" method="post">
...
<div class="modal fade" id="modalProgramKerja" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="index.php?mod=ekskul&act=program_save" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="modalProgramUpload" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="index.php?mod=ekskul&act=program_upload" method="post" enctype="multipart/form-data">
                <div class="modal-header">
...
<div class="modal fade" id="modalGaleri" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="index.php?mod=ekskul&act=galeri_save" method="post" enctype="multipart/form-data">
                <div class="modal-header">
...
$(document).ready(function() {
    ...
    $("#list-left, #list-right").sortable({
        ...
        receive: function(event, ui) {
            ...
            $.post('index.php?mod=ekskul&act=update_anggota', {
    ...
    function loadStudents() {
        ...
        $.getJSON('index.php?mod=ekskul&act=search_students', {id_ekskul: id_ekskul, q: q, id_kelas: k}, function(res){
            if(res.status === 'success'){
                $('#list-left').empty();
                res.data.forEach(s => {
