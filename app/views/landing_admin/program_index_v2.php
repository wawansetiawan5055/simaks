                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-right">
                        <span class="badge badge-light border text-muted px-2 py-1"
                            ...
                            <i class="fas fa-info-circle mr-1"></i> Total: <?= count($program_list) ?> program
                        </span>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-hover align-middle mb-0" style="border-collapse: collapse;">
                    <thead style="background: #f8fafc;">
                        <tr class="text-muted">
                            ...
                            <th class="text-center py-3 border-bottom"
                                style="font-size: 0.7rem; letter-spacing: 1px; width: 100px;">IKON</th>
                            <th class="text-center py-3 border-bottom"
                            ...
                            <?php foreach ($program_list as $index => $item): ?>
                                <tr>
                                    ...
                                    <td class="align-middle py-3">
                                        <div class="d-flex align-items-start">
                                            <div class="rounded d-flex align-items-center justify-content-center mr-2 bg-light text-primary font-weight-bold"
                                                ...
                                                <?php if ($item['image']): ?>
                                                    <img src="<?= BASE_URL ?>uploads/program/<?= htmlspecialchars($item['image']) ?>"
                                    ...
                                    <td class="text-center align-middle">
                                        <i class="<?= htmlspecialchars($item['icon'] ?: 'fas fa-dot-circle') ?> text-muted"></i>
                                    </td>
                                    <td class="text-center align-middle">
