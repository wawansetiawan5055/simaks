...
<section class="content-header">
    <div class="container-fluid">
        <h1 class="m-0 font-weight-bold">LMS System <small class="text-muted">| Edit Modul Ajar &amp; Asisten AI</small></h1>
    </div>
</section>

<section class="content">
    <div class="container-fluid">
        <form action="<?= BASE_URL ?>lms/materi_edit?id=<?php echo $materi['id_materi']; ?>" method="POST" enctype="multipart/form-data" id="formMateri">
            <div class="row">
                <!-- Sidebar Tabs -->
                <div class="col-lg-3">
                    <div class="card lms-card p-3 sticky-top" style="top: 20px; z-index: 100;">
                        ...
                        <button type="submit" class="btn btn-lms-primary btn-block p-3 mt-2 shadow">
                            <i class="fas fa-save mr-2"></i> Simpan Perubahan Modul
                        </button>
                    </div>
                </div>
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="tab-identitas" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input type="text" name="judul_materi" id="judul_materi" class="form-control form-control-lms font-weight-bold" value="<?php echo htmlspecialchars($materi['judul_materi']); ?>" required>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select name="id_mapel" id="id_mapel" class="form-control form-control-lms select2" required>
                                                ...
                                                <?php foreach ($mapel_list as $m): ?>
                                                    <option value="<?php echo $m['id_mapel']; ?>" data-nama="<?php echo htmlspecialchars($m['nama_mapel']); ?>" <?php echo ($materi['id_mapel'] == $m['id_mapel']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($m['nama_mapel']); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            ...
                                            <select name="tingkat" id="tingkat" class="form-control form-control-lms" required>
                                                <option value="X" <?php echo ($materi['tingkat']=='X')?'selected':''; ?>>Kelas X</option>
                                                <option value="XI" <?php echo ($materi['tingkat']=='XI')?'selected':''; ?>>Kelas XI</option>
                                                <option value="XII" <?php echo ($materi['tingkat']=='XII')?'selected':''; ?>>Kelas XII</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-4">
                                            ...
                                            <select name="semester" id="semester" class="form-control form-control-lms" onchange="loadBabList()">
                                                <option value="1" <?php echo ($materi['semester']=='1'||$materi['semester']=='Ganjil')?'selected':''; ?>>Semester 1 (Ganjil)</option>
                                                <option value="2" <?php echo ($materi['semester']=='2'||$materi['semester']=='Genap')?'selected':''; ?>>Semester 2 (Genap)</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <textarea name="cp_manual" id="cp_manual" class="form-control form-control-lms" rows="2"><?php echo htmlspecialchars($materi['cp_manual']); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <textarea name="tp_manual" id="tp_manual" class="form-control form-control-lms" rows="2"><?php echo htmlspecialchars($materi['tp_manual']); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="tab-diagnostik" role="tabpanel">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="instruksi" id="instruksi_editor" class="form-control form-control-lms summernote" rows="5"><?php echo htmlspecialchars($materi['instruksi']); ?></textarea>
                                    </div>
                                    <hr>
                                ...
                                <div class="tab-pane fade" id="tab-video" role="tabpanel">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="url" name="video_url" class="form-control form-control-lms" value="<?php echo htmlspecialchars($materi['video_url']); ?>">
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="tab-pane fade" id="tab-materi" role="tabpanel">
                                    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-ai-sparkle rounded-pill px-3 shadow-sm" id="btnAiGenerateMateri">
                                            <i class="fas fa-magic mr-1"></i> ✨ Susun Ulang Bahan Ajar (AI)
                                        </button>
                                    </div>

                                    <div class="mb-4">
                                        <label class="small font-weight-bold">ISI MATERI (MENDUKUNG TEKS, GAMBAR &amp; RUMUS LATEX $\dots$)</label>
                                        <textarea name="deskripsi" id="deskripsi_materi" class="form-control form-control-lms summernote" rows="12"><?php echo htmlspecialchars($materi['deskripsi']); ?></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <label class="small font-weight-bold">FILE MATERI SAAT INI</label>
                                            <?php if ($materi['file_path']): ?>
                                                <div class="alert alert-light border small"><i class="fas fa-file-pdf mr-2"></i> <?php echo basename($materi['file_path']); ?></div>
                                            <?php endif; ?>
                                            <input type="file" name="file_materi" class="form-control-file">
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <label class="small font-weight-bold">LINK EKSTERNAL</label>
                                            <input type="url" name="external_url" class="form-control form-control-lms" value="<?php echo htmlspecialchars($materi['external_url']); ?>">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-sm btn-ai-sparkle rounded-pill px-3 shadow-sm mr-1" id="btnAiGenerateSoal">
                                                <i class="fas fa-robot mr-1"></i> ✨ Generate Soal Tambahan (AI)
                                            </button>
                                ...
                                <div class="tab-pane fade" id="tab-refleksi" role="tabpanel">
                                    ...
                                    <div class="d-flex justify-content-between mt-5">
                                        ...
                                        <button type="submit" class="btn btn-success px-5 py-2 font-weight-bold shadow-sm"><i class="fas fa-save mr-2"></i> Simpan Perubahan Modul</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    let soalIndex = 0;
    const initialBabId = "<?php echo $materi['id_bab'] ?? ''; ?>";
    const initialSubBabId = "<?php echo $materi['id_sub_bab'] ?? ''; ?>";

    // AJAX: Load Bab based on Mapel & Tingkat
    window.loadBabList = function(callback = null) {
        ...
        $.getJSON(`<?= BASE_URL ?>index.php?mod=lms&act=get_bab_ajax&id_mapel=${idMapel}&tingkat=${tingkat}`, function(res) {
            ...
            if (res.status === 'ok' && res.data && res.data.length > 0) {
                res.data.forEach(b => {
                    const sel = (initialBabId && String(initialBabId) === String(b.id_bab)) ? 'selected' : '';
    ...
    window.loadSubBabList = function() {
        ...
        $.getJSON(`<?= BASE_URL ?>index.php?mod=lms&act=get_sub_bab_ajax&id_bab=${idBab}`, function(res) {
            ...
            if (res.status === 'ok' && res.data && res.data.length > 0) {
                res.data.forEach(s => {
                    const sel = (initialSubBabId && String(initialSubBabId) === String(s.id_sub_bab)) ? 'selected' : '';
                    html += `<option value="${s.id_sub_bab}" ${sel}>Sub-Bab ${s.urutan_sub}: ${s.judul_sub_bab}</option>`;
                });
            }
    ...
    $('#id_mapel, #tingkat').on('change', function() {
        loadBabList();
    });

    // Initial load for Bab & Sub-Bab
    loadBabList(function() {
        if (initialBabId) {
            $('#id_bab').val(initialBabId);
            loadSubBabList();
        }
    });
    ...
    $('#id_mapel, #tingkat').change(function() {
        loadCP();
    });
    ...
    const loadJsonQuestions = () => {
        const diag = <?php 
            $diag_val = json_decode($materi['tes_diagnostik_config'] ?? '[]', true);
            echo is_array($diag_val) ? json_encode($diag_val) : '[]'; 
        ?>;
        const vQ = <?php echo $materi['video_questions'] ?? '[]'; ?>;
        const mQ = <?php echo $materi['materi_questions'] ?? '[]'; ?>;

        if (Array.isArray(diag)) diag.forEach(q => addQuestion('diagnostik', q));
        if (Array.isArray(vQ)) vQ.forEach(q => addQuestion('video', q));
        if (Array.isArray(mQ)) mQ.forEach(q => addQuestion('materi', q));
    };
    loadJsonQuestions();
    ...
    $('#btnAiGenerateMateri').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                btn.prop('disabled', false).html('<i class="fas fa-magic mr-1"></i> ✨ Susun Ulang Bahan Ajar (AI)');
    ...
    // Load existing soal into form
    const existingSoal = <?php echo json_encode($soal_list ?? []); ?>;
    if (existingSoal && existingSoal.length > 0) {
        existingSoal.forEach(q => {
            window.addSoalToContainer(q);
        });
    }
    ...
    // Auto load CP & TP
    setTimeout(() => {
        const selectedCp = "<?php echo $materi['id_cp'] ?? ''; ?>";
        const selectedTp = "<?php echo $materi['id_tp'] ?? ''; ?>";
        
        if (selectedCp) {
            $('#id_mapel').trigger('change');
            setTimeout(() => {
                $('#id_cp').val(selectedCp).trigger('change');
                
                setTimeout(() => {
                    if (selectedTp) {
                        const tpArr = selectedTp.split(',');
                        tpArr.forEach(id => {
                            $(`#tp_${id}`).prop('checked', true);
                        });
                    }
                }, 500);
            }, 500);
