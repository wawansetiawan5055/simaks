...
<head>
    ...
    <title>Program Sekolah - <?= $config['website_name'] ?? 'SMA Plus Al-Manshuriyah' ?></title>
...
<body class="bg-light">
    ...
    <header class="page-header" style="background: #1a237e; color: white; padding: 4rem 0 2rem; text-align: center;">
        <div class="container">
            <h1 class="display-6 fw-bold mb-2">Program Sekolah</h1>
            <p class="lead opacity-75">Membentuk masa depan melalui pendidikan berkualitas</p>
        </div>
    </header>
                            ...
                            <div class="card h-100 shadow-sm program-card">
                                ...
                                <?php if ($program['gambar']): ?>
                                    <div class="card-img-top-container">
                                        <img src="<?= BASE_URL ?>uploads/landing/<?= htmlspecialchars($program['gambar']) ?>"
                                            class="card-img-top" alt="<?= htmlspecialchars($program['nama_program']) ?>"
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <!-- Program Details -->
                                    <div class="program-details mt-auto">
                                        <div class="row g-2 text-center">
                                            <?php if ($program['durasi']): ?>
                                                <div class="col-6">
                                                    <div class="p-2 bg-light rounded">
                                                        <small class="text-muted d-block">Durasi</small>
                                                        <strong class="text-primary">
                                                            <?= htmlspecialchars($program['durasi']) ?>
                                                        </strong>
                                                    </div>
                                                </div>
                                            <?php endif; ?>

                                            <?php if ($program['biaya']): ?>
                                                <div class="col-6">
                                                    <div class="p-2 bg-light rounded">
                                                        <small class="text-muted d-block">Biaya</small>
                                                        <strong class="text-success">
                                                            <?= htmlspecialchars($program['biaya']) ?>
                                                        </strong>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                ...
                                <div class="card-footer bg-transparent border-0 pt-0">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php if ($program['link_pendaftaran']): ?>
                                            <a href="<?= htmlspecialchars($program['link_pendaftaran']) ?>"
