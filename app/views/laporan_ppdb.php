<?php
// app/views/laporan_ppdb.php - Laporan PPDB with Dual-Tab Inline Paper Studio
    ...
    <div class="row align-items-center">
      <div class="col-sm-6 col-12 d-flex align-items-center">
        ...
        <div>
          ...
          <p class="text-muted small m-0">Rekapitulasi calon peserta didik diterima &amp; cetak berkas PPDB</p>
        </div>
      </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap no-print">
      ...
      <div class="d-flex align-items-center gap-2 mt-2 mt-md-0">
        <span class="badge badge-light border px-3 py-2 text-dark font-weight-bold shadow-sm" style="font-size: 0.88rem;">
          <i class="fas fa-user-check text-primary mr-1"></i> Total Diterima: <?= count($list ?? []) ?> Siswa
        </span>
      </div>
    </div>
        ...
        <div class="card shadow-sm border-0 mb-3 no-print">
          <div class="card-body p-3 d-flex justify-content-between align-items-center flex-wrap">
            <div class="font-weight-bold text-dark">
              <i class="fas fa-calendar-check text-primary mr-1"></i> Tahun Ajaran PPDB: <strong><?= htmlspecialchars($nama_ta) ?></strong>
            </div>
            <div class="btn-group shadow-sm mt-2 mt-md-0">
              <a href="<?= BASE_URL ?>laporan/ppdb_export_excel" class="btn btn-success font-weight-bold px-3">
                <i class="fas fa-file-excel mr-1"></i> Export Excel
              </a>
              <a href="<?= BASE_URL ?>laporan/ppdb_export_pdf" class="btn btn-danger font-weight-bold px-3" target="_blank">
        ...
        <div class="card shadow-sm border-0 mb-3 bg-white btn-studio-toolbar no-print">
          <div class="card-body p-3 d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="btn-group shadow-sm mt-2 mt-md-0">
              ...
              <a href="<?= BASE_URL ?>laporan/ppdb_export_pdf" class="btn btn-danger font-weight-bold px-3 d-flex align-items-center" target="_blank">
                <i class="fas fa-file-pdf mr-1"></i> Download PDF
              </a>
              <a href="<?= BASE_URL ?>laporan/ppdb_export_excel" class="btn btn-success font-weight-bold px-3 d-flex align-items-center">
        ...
        <div class="simaks-paper-studio-container">
          <div class="simaks-paper-sheet">
            ...
            <div class="simaks-doc-title">
              LAPORAN PENERIMAAN PESERTA DIDIK BARU (PPDB)
            </div>
                ...
                <?php if (empty($list)): ?>
                  <tr>
                    <td colspan="6" style="text-align: center; padding: 20px; font-style: italic;">
                      Tidak ada data PPDB untuk ditampilkan.
                    </td>
                  </tr>
                <?php else: ?>
                  <?php $no = 1; foreach ($list as $data): ?>
                    <tr>
                      ...
                      <td style="text-align: center; font-family: monospace;"><?= htmlspecialchars($data['nomor_pendaftaran'] ?? '-') ?></td>
                      <td style="font-weight: bold;"><?= htmlspecialchars($data['nama_lengkap']) ?></td>
                      <td style="text-align: center; font-family: monospace;"><?= htmlspecialchars($data['nisn'] ?: '-') ?></td>
                      <td style="text-align: center;"><?= htmlspecialchars($data['jenis_kelamin']) ?></td>
                      <td><?= htmlspecialchars($data['sekolah_asal'] ?: '-') ?></td>
                    </tr>
                  <?php endforeach; ?>
                <?php endif; ?>
            ...
            <table class="simaks-doc-signature">
              <tr>
                ...
                <td width="50%">
                  ...
                  Ketua Panitia PPDB
                  <br><br><br><br>
                  <strong><u><?= htmlspecialchars($_SESSION['nama_lengkap'] ?? 'Panitia PPDB') ?></u></strong><br>
                  NIP. -
                </td>
              </tr>
            </table>
