...
<div class="container-fluid">
  <h2 class="mt-4 mb-3" style="font-size: 1.75rem; font-weight: 600;">Laporan Absensi Guru</h2>
  ...
  <div class="mb-3">
    ...
    ?>
    <a href="index.php?mod=laporan&act=absensi_guru_export_excel&<?= $query_params ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export Excel</a>
    <a href="index.php?mod=laporan&act=absensi_guru_export_pdf&<?= $query_params ?>" class="btn btn-danger btn-sm"><i class="fas fa-file-pdf"></i> Export PDF</a>
    <button type="button" onclick="showReportPreview('index.php?mod=laporan&act=absensi_guru_print&<?= $query_params ?>', 'Laporan Absensi Guru')" class="btn btn-info btn-sm"><i class="fas fa-print"></i> Cetak</button>
  </div>
