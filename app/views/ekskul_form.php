...
<section class="content-header">
    <div class="container-fluid">
        <h1><i class="fas fa-edit mr-2"></i> <?= $ekskul ? 'Edit' : 'Tambah' ?> Ekstrakurikuler</h1>
    </div>
</section>
            ...
            <form action="<?= BASE_URL ?>ekskul/save" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="id_penugasan" id="nama_ekskul" class="form-control select2" required>
                            ...
                            <?php foreach ($assigned_activities as $act): ?>
                                ...
                                <option value="<?= $act['id_penugasan_pembina'] ?>" data-guru-id="<?= $act['id_guru'] ?>"
                                    ...
                                    <?= ($ekskul['nama_ekskul'] ?? '') == $act['nama_kegiatan'] && ($ekskul['id_guru_pembina'] ?? '') == $act['id_guru'] ? 'selected' : '' ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="statusSwitch" name="status"
                                value="Aktif" <?= ($ekskul['status'] ?? 'Aktif') == 'Aktif' ? 'checked' : '' ?>>
...
<script>
    $(document).ready(function () {
        ...
        // Auto-fill Pembina on Change
        $('#nama_ekskul').on('change', function () {
