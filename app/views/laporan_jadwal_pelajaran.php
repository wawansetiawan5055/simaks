    ...
    <div class="card card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="index.php?mod=laporan&act=jadwal_pelajaran_export_excel&filter_type=<?= $filter_type ?>&kelas=<?= $kelas ?>&guru=<?= $guru ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export Excel</a>
                <a href="index.php?mod=laporan&act=jadwal_pelajaran_export_pdf&filter_type=<?= $filter_type ?>&kelas=<?= $kelas ?>&guru=<?= $guru ?>" class="btn btn-danger btn-sm" target="_blank"><i class="fas fa-file-pdf"></i> Export PDF</a>
                <button type="button" onclick="showReportPreview('index.php?mod=laporan&amp;act=jadwal_pelajaran_print&filter_type=<?= $filter_type ?>&kelas=<?= $kelas ?>&guru=<?= $guru ?>', 'Laporan Jadwal Pelajaran')" class="btn btn-info btn-sm"><i class="fas fa-print"></i> Cetak</button>
            </div>
        </div>
