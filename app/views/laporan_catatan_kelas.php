    ...
    <div class="row align-items-center">
      ...
      <div class="col-sm-6 col-12 text-sm-right mt-2 mt-sm-0">
        <ol class="breadcrumb float-sm-right mb-0 bg-transparent p-0">
          ...
          <li class="breadcrumb-item active text-primary font-weight-bold">Laporan Kejadian</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="card card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?= BASE_URL ?>laporan/catatan_kelas_export_excel?kelas=<?= $kelas ?>&tanggal1=<?= $tanggal1 ?>&tanggal2=<?= $tanggal2 ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export Excel</a>
                <a href="<?= BASE_URL ?>laporan/catatan_kelas_export_pdf?kelas=<?= $kelas ?>&tanggal1=<?= $tanggal1 ?>&tanggal2=<?= $tanggal2 ?>" class="btn btn-danger btn-sm" target="_blank"><i class="fas fa-file-pdf"></i> Export PDF</a>
                <button type="button" onclick="showReportPreview('<?= BASE_URL ?>laporan/catatan_kelas_print?kelas=<?= $kelas ?>&tanggal1=<?= $tanggal1 ?>&tanggal2=<?= $tanggal2 ?>', 'Laporan Catatan Kelas')" class="btn btn-info btn-sm" title="Cetak"><i class="fas fa-print"></i> Cetak</button>
            </div>
        </div>
