<?php
// app/views/laporan_catatan_kelas.php - Unified Seamless In-Body PDF Preview Studio
...
$pdf_url = BASE_URL . 'laporan/catatan_kelas_export_pdf?' . $query_string_custom;
$excel_url = BASE_URL . 'laporan/catatan_kelas_export_excel?' . $query_string_custom;
      ...
      <div class="card shadow-sm border-0">
        <div class="card-header bg-white border-bottom-0 pt-3 pb-2 d-flex justify-content-between align-items-center flex-wrap">
          <h3 class="card-title font-weight-bold text-dark mb-2 mb-md-0">
            <i class="fas fa-list text-primary mr-1"></i> Hasil Catatan Kejadian Kelas (<?= htmlspecialchars($selected_kelas_name) ?>)
          </h3>
      ...
      <div class="preview-unified-header">
        <div class="d-flex align-items-center">
          ...
          <div class="preview-unified-title d-none d-md-flex">
            ...
            <span>Pratinjau: Laporan Catatan Kejadian Kelas</span>
          </div>
        </div>
