<?php
// app/views/laporan_catatan_kelas.php - Laporan Catatan Kejadian Kelas with Dual-Tab Inline Paper Studio
    ...
    <div class="row align-items-center">
      <div class="col-sm-6 col-12 d-flex align-items-center">
        ...
        <div>
          <h4 class="m-0 font-weight-bold text-dark" style="font-family: 'Poppins', sans-serif;">
            Laporan Catatan Kejadian Kelas
          </h4>
          <p class="text-muted small m-0">Rekapitulasi log harian dinamika kelas, kejadian khusus &amp; pembinaan</p>
        </div>
      </div>
      <div class="col-sm-6 col-12 text-sm-right mt-2 mt-sm-0">
        <ol class="breadcrumb float-sm-right mb-0 bg-transparent p-0">
          ...
          <li class="breadcrumb-item active text-primary font-weight-bold">Laporan Kejadian Kelas</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap no-print">
      ...
      <div class="d-flex align-items-center gap-2 mt-2 mt-md-0">
        <span class="badge badge-light border px-3 py-2 text-dark font-weight-bold shadow-sm" style="font-size: 0.88rem;">
          <i class="fas fa-tasks text-primary mr-1"></i> Total: <?= count($list ?? []) ?> Catatan
        </span>
      </div>
    </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-bottom-0 pt-3 pb-2 d-flex justify-content-between align-items-center flex-wrap">
                <h3 class="card-title font-weight-bold text-dark mb-2 mb-md-0">
                    <i class="fas fa-list text-primary mr-1"></i> Hasil Catatan Kejadian (<?= htmlspecialchars($selected_kelas_name) ?>)
                </h3>
                <div class="btn-group shadow-sm">
                    <a href="<?= BASE_URL ?>laporan/catatan_kelas_export_excel?<?= $query_string_custom ?>" class="btn btn-success btn-sm font-weight-bold px-3">
                        <i class="fas fa-file-excel mr-1"></i> Excel
                    </a>
                    <a href="<?= BASE_URL ?>laporan/catatan_kelas_export_pdf?<?= $query_string_custom ?>" class="btn btn-danger btn-sm font-weight-bold px-3" target="_blank">
                    ...
                    <table class="table table-striped table-hover m-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th>Deskripsi Kejadian / Catatan Guru</th>
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($list as $l): ?>
                                <tr>
                                    ...
                                    <td class="font-weight-bold text-dark"><?= htmlspecialchars($l['nama_guru'] ?? '-') ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
        ...
        <div class="card shadow-sm border-0 mb-3 bg-white btn-studio-toolbar no-print">
            <div class="card-body p-3 d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="btn-group shadow-sm mt-2 mt-md-0">
                    ...
                    <a href="<?= BASE_URL ?>laporan/catatan_kelas_export_pdf?<?= $query_string_custom ?>" class="btn btn-danger font-weight-bold px-3 d-flex align-items-center" target="_blank">
                        <i class="fas fa-file-pdf mr-1"></i> Download PDF
                    </a>
                    <a href="<?= BASE_URL ?>laporan/catatan_kelas_export_excel?<?= $query_string_custom ?>" class="btn btn-success font-weight-bold px-3 d-flex align-items-center">
                        <i class="fas fa-file-excel mr-1"></i> Excel
                    </a>
                </div>
            </div>
                ...
                <table class="simaks-doc-table">
                    <thead>
                        <tr>
                            ...
                            <th width="14%">Tanggal</th>
                            <th width="12%">Kelas</th>
                            <th>Deskripsi Kejadian / Catatan</th>
                            <th width="22%">Guru Pencatat</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (empty($list)): ?>
                ...
                <table class="simaks-doc-signature">
                    <tr>
                        ...
                        <td width="50%">
                            ...
                            <br><br><br><br>
                            <strong><u><?= htmlspecialchars($_SESSION['nama_lengkap'] ?? 'Guru Pengampu') ?></u></strong><br>
                            NIP. -
                        </td>
                    </tr>
                </table>
