...
<head>
    ...
    // Default Values
    $t_font_size = $theme_config['theme_font_size'] ?? '0.85rem';
    $t_font_header = $theme_config['theme_font_header'] ?? '1.5rem';
    $t_font_subtitle = $theme_config['theme_font_subtitle'] ?? '1.1rem';
    $t_font_table_header = $theme_config['theme_font_table_header'] ?? '0.875rem';
    $t_font_table_content = $theme_config['theme_font_table_content'] ?? '0.85rem';
    $t_font_body = $theme_config['theme_font_body'] ?? '1rem';
    $t_font_small = $theme_config['theme_font_small'] ?? '0.8rem';

    $t_color_header = $theme_config['theme_color_header'] ?? '#3b82f6';
    $t_color_subtitle = $theme_config['theme_color_subtitle'] ?? '#1e293b';
    $t_color_table_header = $theme_config['theme_color_table_header'] ?? '#475569';
    $t_color_table_content = $theme_config['theme_color_table_content'] ?? '#334155';
    $t_color_body = $theme_config['theme_color_body'] ?? '#334155';
    $t_color_small = $theme_config['theme_color_small'] ?? '#64748b';
    $t_color_sidebar_text = $theme_config['theme_color_sidebar_text'] ?? '#cbd5e1';
    ...
    $t_menu_active = $theme_config['theme_menu_active_bg'] ?? $t_accent;

    // Sidebar Style Logic
    $sidebar_style_css = "";
    switch ($t_sidebar) {
        case 'glass_blue':
            $sidebar_style_css = "background-color: rgba(10, 35, 70, 0.85) !important; backdrop-filter: blur(10px) !important; -webkit-backdrop-filter: blur(10px) !important; box-shadow: 4px 0 15px rgba(20, 50, 100, 0.15) !important; border-right: 1px solid rgba(255, 255, 255, 0.08);";
            break;
        case 'royal_blue':
            $sidebar_style_css = "background: linear-gradient(180deg, rgba(20, 60, 120, 0.9) 0%, rgba(10, 30, 70, 0.9) 100%) !important; backdrop-filter: blur(8px) !important; -webkit-backdrop-filter: blur(8px) !important; box-shadow: 4px 0 15px rgba(30, 80, 150, 0.2) !important; border-right: 1px solid rgba(255, 255, 255, 0.1);";
            break;
        case 'slate_matte':
            $sidebar_style_css = "background: linear-gradient(180deg, #3f576c 0%, #2c3e50 100%) !important; box-shadow: 2px 0 10px rgba(0, 0, 0, 0.1) !important; border-right: none;";
            break;
        case 'emerald_forest':
            $sidebar_style_css = "background: linear-gradient(180deg, #064e3b 0%, #065f46 100%) !important; box-shadow: 4px 0 15px rgba(0, 50, 0, 0.2) !important; border-right: 1px solid rgba(255, 255, 255, 0.05);";
            break;
        case 'indigo_violet':
            $sidebar_style_css = "background: linear-gradient(180deg, #312e81 0%, #4c1d95 100%) !important; box-shadow: 4px 0 15px rgba(50, 0, 100, 0.2) !important; border-right: 1px solid rgba(255, 255, 255, 0.1); text-shadow: 0 0 10px rgba(255, 255, 255, 0.1);";
            break;
        case 'deep_carbon':
            $sidebar_style_css = "background: linear-gradient(180deg, #111827 0%, #000000 100%) !important; box-shadow: 4px 0 15px rgba(0, 0, 0, 0.4) !important; border-right: 1px solid rgba(255, 255, 255, 0.03);";
            break;
        case 'warm_gold':
            $sidebar_style_css = "background: linear-gradient(180deg, #451a03 0%, #78350f 100%) !important; box-shadow: 4px 0 15px rgba(50, 20, 0, 0.3) !important; border-right: 1px solid rgba(255, 255, 255, 0.05);";
            break;
        case 'midnight_blue':
        default:
            $sidebar_style_css = "background: linear-gradient(180deg, #020617 0%, #0f172a 100%) !important; box-shadow: 4px 0 15px rgba(0, 0, 0, 0.2) !important; border-right: 1px solid rgba(255, 255, 255, 0.05);";
            break;
    }
    ?>
    ...
    <style>
        ...
        :root {
            ...
            ;
            --color-table-header:
                <?= $t_color_table_header ?>
            ;
            --color-table-content:
                <?= $t_color_table_content ?>
            ;
            --color-body:
                <?= $t_color_body ?>
            ;
        ...
        h2,
        .h2 {
            font-size: calc(var(--font-header) * 0.85) !important;
        }

        h3,
        .h3 {
            font-size: calc(var(--font-header) * 0.75) !important;
        }
        ...
        .table thead th,
        .table thead th * {
            color: var(--color-table-header, #475569) !important;
        ...
        tbody td,
        .table tbody td {
            font-size: var(--font-table-content) !important;
            color: var(--color-table-content, var(--text-color));
        }
        ...
        .nav-sidebar .nav-item .nav-link.active::after {
            ...
            left: 50%;
            width: 250%;
            /* Slightly larger for smoother overlap */
            height: 250%;
        ...
        .nav-sidebar .nav-item .nav-link.active::before {
            ...
            /* Use user-selected color as base */
